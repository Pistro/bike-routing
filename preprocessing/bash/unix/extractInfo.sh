...
osmosis \
  ...
  --used-node \
  --write-xml ../source/inter/$1_primary.osm
...
osmosis \
  ...
  --used-node \
  --write-xml ../source/inter/$1_secondary.osm
...
osmosis \
  ...
  --used-node \
  --write-xml ../source/inter/$1_tertiary.osm
...
osmosis \
  ...
  --write-xml ../source/inter/$1_poi.osm
...
osmosis \
  ...
  --used-node \
  --write-xml ../source/inter/$1_forest_way.osm
...
osmosis \
  ...
  --write-xml ../source/inter/$1_forest_rel.osm
...
osmosis \
  ...
  --write-xml ../source/inter/$1_water.osm
}
