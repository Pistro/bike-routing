...
call python osm2graph ^
	...
	--xml out=..\source\inter\%1_edge.osm ..\source\inter\%1_way.osm

call python osm2graph ^
	--verbose ^
	--poi in=..\source\inter\%1_poi.osm remap=amenity.bar,amenity.bbq,amenity.biergarten,amenity.cafe,amenity.drinking_water,amenity.fast_food,amenity.ice_cream,amenity.pub,amenity.restaurant,amenity.bicycle_parking,amenity.bicycle_repair_station,amenity.bicycle_rental,amenity.car_wash,amenity.charging_station,amenity.fuel,amenity.parking.car_parking,amenity.fountain,amenity.place_of_worship,amenity.toilets ^
	--pass-through in=..\source\inter\%1_forest_way.osm remap=landuse.forest,natural.wood ^
	--pass-through rel in=..\source\inter\%1_forest_rel.osm remap=landuse.forest,natural.wood ^
	--pass-near in=..\source\inter\%1_water.osm tag=waterside ^
	--pass-near in=..\source\inter\%1_primary.osm tag=primaryside ^
	--pass-near in=..\source\inter\%1_secondary.osm tag=secondaryside ^
	--pass-near in=..\source\inter\%1_tertiary.osm tag=tertiaryside ^
	...
	--step ^
	--edge-info ^
	--xml out=..\source\inter\%1_inter.osm ^
	...
	--fix out=..\source\output\%1_fixture.xml ..\source\inter\%1_edge.osm
goto :eof